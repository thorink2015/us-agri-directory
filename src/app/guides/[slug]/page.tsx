    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <article>
          <header className="mb-8">
            <div className="flex items-center gap-2 text-xs text-gray-500 mb-3">
              ...
              <span className="flex items-center gap-1">
                <Calendar className="w-3 h-3" /> Updated {new Date(guide.lastUpdated).toLocaleDateString('en-US')}
              </span>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <h2 className="text-xl font-bold text-gray-900 mb-4">More Guides</h2>
        ...
        <div className="mt-8 bg-green-50 border border-green-200 rounded-xl p-6 text-center">
          <h2 className="font-bold text-gray-900 mb-2">Looking for an ag drone operator?</h2>
