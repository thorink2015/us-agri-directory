...
export const services: ServiceDefinition[] = [
  ...
  },
  {
    ...
    longDescription:
      'Agricultural drone sales in the US run through three primary channels: authorized DJI Agras dealers (HSE-UAV, Drone Nerds, AgriSpray Drones), US-manufactured Hylio direct and through resellers, and XAG, Guardian Agriculture, and Pyka through their own channel networks. 2026 MSRP on the DJI Agras T50 runs $18,000 to $25,000 for the full ready-to-fly kit including batteries, generator, and trailer setup. Hylio AG-272 runs $35,000 to $45,000 with NDAA compliance as the primary differentiator for operators working federal, state, or NDAA-restricted contracts. XAG P100 Pro sits at $22,000 to $28,000, Guardian Agriculture SC1 at $250,000 to $350,000 for its larger autonomous platform, and Pyka Pelican in the $300,000 to $500,000 range as a crewed-class alternative. Financing is available through manufacturer programs, farm credit associations, and USDA FSA Farm Loan programs with 2 to 7 year terms and 10 to 25 percent down. USDA EQIP Practice Code 595 (Precision Agriculture) in many states offers 40 to 90 percent cost-share on drone purchases for qualifying farmers.',
    aeoBlock:
      'DJI Agras T50 ready-to-fly kits sell for $18,000 to $25,000 in 2026, Hylio AG-272 runs $35,000 to $45,000 with NDAA compliance, and XAG P100 Pro is $22,000 to $28,000. USDA EQIP Practice Code 595 (Precision Agriculture) offers 40 to 90 percent cost-share on qualifying drone purchases in most states. Financing is available through manufacturer programs, farm credit, and USDA FSA Farm Loans with 2 to 7 year terms.',
    priceMinUsd: 18000,
    priceMaxUsd: 75000,
    priceUnit: 'per drone',
    icon: '🛒',
